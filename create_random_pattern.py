...
def draw(width, height, color=200, backgroundColor=(0,0,0), perlinFactorW=2, perlinFactorH=2, step=0.001):
    ...
    save(p, fname=f'./images/{args.file}', folder='.', overwrite=True)

color = random.randint(0, 100000000)
draw(1200, 1500, color=color, perlinFactorW=1, perlinFactorH=1, step=0.001)
